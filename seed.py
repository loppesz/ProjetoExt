...
with app.app_context():
    ...
    db.session.commit()
    print('Usuários criados com sucesso (Senha padrão: 123456)')

    # 3. Criar Pets de Exemplo (já aprovados para aparecerem na Home)
    pet1 = Pet(
        usuario_id=maria.id, nome='Tarzam', especie='dog', raca='SRD (Vira-lata)', porte='small', sexo='male',
    ...
    pet2 = Pet(
        usuario_id=carlos.id, nome='Luna', especie='cat', raca='Siamês', porte='small', sexo='female',
        ...
        cidade='Rio de Janeiro', estado='RJ', status='available', mod_status='approved', 
        foto_capa='https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=800'
    )
    
    pet3 = Pet(
        usuario_id=maria.id, nome='Bob', especie='dog', raca='SRD (Vira-lata)', porte='medium', sexo='male',
    ...
    pet4 = Pet(
        usuario_id=carlos.id, nome='Mia', especie='cat', raca='Persa', porte='small', sexo='female',
        idade_anos=0, idade_meses=8, cor='Branco', vacinado=True, castrado=False,
        descricao='Mia é tranquila e adora colos.', 
        cidade='Curitiba', estado='PR', status='available', mod_status='approved', 
        foto_capa='https://images.unsplash.com/photo-1574158622682-e40e69881006?w=800'
    )
    
    pet5 = Pet(
        usuario_id=maria.id, nome='Rex', especie='dog', raca='Pastor Alemão', porte='large', sexo='male',
    ...
    pet6 = Pet(
        usuario_id=maria.id, nome='Nina', especie='dog', raca='Poodle', porte='small', sexo='female',
    ...
    ong1 = Ong(
        ...
        chave_pix='patinhasdob@gmail.com', link_vakinha='https://www.vakinha.com.br'
    )
    
    ong2 = Ong(
        nome='Amicão Muriaé', cidade='Muriaé', estado='RJ',
        ...
        chave_pix='amicãomuriae@gmail.com', link_vakinha='https://www.vakinha.com.br'
    )
    
    ong3 = Ong(
        nome='Amigos de Patas', cidade='Belo Horizonte', estado='MG',
        ...
        chave_pix='amigospatinhas@gmail.com', link_vakinha='https://www.vakinha.com.br'
    )
    
    ong4 = Ong(
        nome='Refúgio Animal Sul', cidade='Porto Alegre', estado='RS',
        ...
        chave_pix='refugioanimalsul@gmail.com', link_vakinha='https://www.vakinha.com.br'
    )
